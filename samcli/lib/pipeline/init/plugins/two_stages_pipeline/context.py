...
class Context:
    ...
    def __init__(self, context: Dict[str, str]):
        ...
        self.deployer_aws_access_key_id_variable_name = context.get("deployer_aws_access_key_id_variable_name")
        self.deployer_aws_secret_access_key_variable_name = context.get("deployer_aws_secret_access_key_variable_name")
